...
- כל המסכים קיימים במבנה בסיסי.
- RTL פעיל.
- העיצוב הראשוני תואם לשפה הגרפית שהוגדרה.
...
- מסך המשחק מציג Canvas תקין.
- התותח מופיע בתחתית המסך.
- לחיצה או נגיעה מסובבת את התותח.
- כל לחיצה יוצרת קליע אחד.
